...
RShop is a full-stack Node.js project using PostgreSQL, JWT authentication, and Google OAuth support.
...
Follow the setup steps above and keep secrets out of version control. See `MIGRATION_GUIDE.md` for PostgreSQL setup and deployment notes.
